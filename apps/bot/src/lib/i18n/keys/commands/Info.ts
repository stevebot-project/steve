...
export const WhoisEmbedAccountCreated = T("commands/info:whois_embed_account_created");
export const WhoisEmbedDisplayName = T("commands/info:whois_embed_display_name");
