...
declare module 'klasa' {
	export interface LanguageKeys {
		...
		COMMAND_ROLL_RESPONSE: string;
		COMMAND_ROLL_EMOJI_RESPONSE: (emoji: string, message: string) => string;
		...
		SERIALIZER_COLOR_INVALID_HEX: (code: string) => string;
		SERIALIZER_TRUSTEDROLESETTING_INVALID_SETTING: (setting: string) => string;
	}
}
