...
export interface LanguageKeys {
	...
	RESOLVER_MUTLI_TOO_FEW: (name: string, min: number) => string;
	...
	COMMAND_EVAL_OUPUT: (time: string, output: string, type: string) => string;
	...
	COMMAND_CON_KEY_NOT_ARRAY: string;
	...
	EVENT_GUILDMEMBER_ADD_HUMANTITLE: string;
